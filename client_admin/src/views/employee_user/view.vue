		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','employee_job_number') || $check_field('add','employee_job_number') || $check_field('set','employee_job_number')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="员工工号" prop="employee_job_number">
					<el-input id="employee_job_number" v-model="form_sub['employee_job_number']" placeholder="请输入员工工号"
							  v-if="user_group === '管理员' || (form_sub['employee_user_id'] && $check_field('set','employee_job_number')) || (!form_sub['employee_user_id'] && $check_field('add','employee_job_number'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','employee_name') || $check_field('add','employee_name') || $check_field('set','employee_name')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="员工姓名" prop="employee_name">
					<el-input id="employee_name" v-model="form_sub['employee_name']" placeholder="请输入员工姓名"
							  v-if="user_group === '管理员' || (form_sub['employee_user_id'] && $check_field('set','employee_name')) || (!form_sub['employee_user_id'] && $check_field('add','employee_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','department') || $check_field('add','department') || $check_field('set','department')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="部门" prop="department">
					<el-select id="department" v-model="form_sub['department']"
						v-if="user_group === '管理员' || (form_sub['employee_user_id'] && $check_field('set','department')) || (!form_sub['employee_user_id'] && $check_field('add','department'))">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','position') || $check_field('add','position') || $check_field('set','position')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="职位" prop="position">
					<el-input id="position" v-model="form_sub['position']" placeholder="请输入职位"
							  v-if="user_group === '管理员' || (form_sub['employee_user_id'] && $check_field('set','position')) || (!form_sub['employee_user_id'] && $check_field('add','position'))"></el-input>
